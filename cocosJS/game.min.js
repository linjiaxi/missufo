...
var a=new GameLayer;this.addChild(a)}});var Constant={CANDY_WIDTH:64,CANDY_TYPE_COUNT:5,MAP_SIZE:10,FALL_ACCELERATION:30,levels:[{limitStep:30,targetScore:500},{limitStep:25,targetScore:1E3},{limitStep:20,targetScore:2E3},{limitStep:20,targetScore:3E3},{limitStep:15,targetScore:4E3},{limitStep:10,targetScore:5E3}]};var Storage={getCurrentLevel:function(){var a=cc.sys.localStorage.getItem("level")||0;return parseInt(a)},setCurrentLevel:function(a){cc.sys.localStorage.setItem("level",a);return!0},getCurrentScore:function(){var a=cc.sys.localStorage.getItem("score")||0;return parseInt(a)},setCurrentScore:function(a){cc.sys.localStorage.setItem("score",a);return!0}};var GameUI=cc.Layer.extend({levelText:null,scoreText:null,stepText:null,gameLayer:null,ctor:function(a){this._super();this.gameLayer=a;this._initInfoPanel();this.scheduleUpdate()},createTextLJC:function(a){a=a||{};var b={text:"text",fontFamily:"Arial",fontSzie:36,textX:100,textY:100,color:cc.color(0,0,0)};a=this.extendLJC(a,b);b=new cc.LabelTTF(a.text,a.fontFamily,a.fontSzie);b.x=a.textX;b.y=a.textY;b.setColor(a.color);this.addChild(b);return b},extendLJC:function(a,b){for(var c in a){var d=c,e=a[c],
f;for(f in b)d==f?b[f]=e:b[f]=b[f]}return b},_initInfoPanel:function(){var a=cc.director.getWinSize(),a=this.createTextLJC({text:"Level",textX:100,textY:a.height-50}),b=this.createTextLJC({text:"1",textX:100,textY:a.y-40});this.levelText=b;this.createTextLJC({text:"Score",textX:370,textY:a.y});this.scoreText=this.createTextLJC({text:"1",textX:370,textY:b.y});this.createTextLJC({tetx:"Step",textX:620,textY:a.y});this.stepText=this.createTextLJC({text:"1",textX:620,textY:b.y})},update:function(){this.levelText.setString(""+
